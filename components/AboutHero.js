...
const AboutHero = () => {
  ...
  if (width > 0 && width < tabletBreakpoint) {
    return (
      <>
        <main className="w-full max-w-[308px] mx-auto mt-24 px-4 pb-8 font-inter">
          ...
          <section className="flex flex-row items-center justify-between">
            ...
            <div className="w-1/2 text-left pl-10">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="mt-8 inline-block bg-pink text-white px-10 py-3 rounded-[10px] text-lg border-2 border-transparent hover:bg-white hover:text-pink hover:border-pink duration-300 transition"
                style={noTapHighlight}
              >
                Join the Team
              </a>
